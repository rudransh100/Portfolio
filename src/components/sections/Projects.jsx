    ...
    return (
        <section id='projects' className="pt-28 pb-20 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 min-h-screen">
            ...
            <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true }} className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-stretch">
                ...
                <div className=" relative h-full p-5 sm:p-6 md:p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700">
                    ...
                    <div className="flex gap-2">
                        <a href="https://react-project-swart-psi.vercel.app/" target="_blank" rel="noopener noreferrer"
                    ...
                    <a href="https://github.com/rudransh100/React-project" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center bg-slate-800 border border-slate-700 rounded-xl mb-4 text-white hover:border-purple-500 hover:rotate-5 hover:scale-110 transition-all duration-300">
            ...
            <motion.div variants={slideRight} className="relative group">
                ...
                <div className="relative h-full p-5 sm:p-6 md:p-8 border border-slate-800 bg-slate-900 rounded-2xl hover:border-slate-700">
                    ...
                    <div className="flex gap-2">
                        ...
                        <a href="https://color-palette-generator-seven-lake.vercel.app/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-slate-700 bg-slate-800 flex items-center justify-center rounded-xl mb-4 hover:border-blue-500 hover:rotate-5 hover:scale-110 transition-all duration-300">
                            <ExternalLink className='w-4 h-4 text-white'/>
                        </a>

                        <a href="https://github.com/rudransh100/color-palette-generator" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-slate-700 bg-slate-800 flex items-center justify-center rounded-xl mb-4 hover:border-blue-500 hover:rotate-5 hover:scale-110 transition-all duration-300">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true,             margin: "-100px" }} variants={slideUp} className="mt-12 text-center">
                ...
                <motion.a href="https://github.com/kushB645" target="_blank" rel="noopener noreferrer" className="inline-flex gap-2 justify-center items-center border border-slate-700 rounded-full px-8 py-3 text-white hover:border-blue-500 hover:bg-slate-800/50 hover:scale-105 transition-all duration-300">
