...
const Skills = () => {
    ...
    return (
        ...
        >
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true,             margin: "-100px" }} variants={slideUp} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto px-4">
          {/* grid-1 */}
            ...
            <div className="border border-slate-800 bg-slate-900 p-5 sm:p-6 rounded-2xl hover:border-slate-700  hover:-translate-y-2 transition-all duration-300 h-full ">
              ...
              <h3 className='text-white text-lg leading-relaxed tracking-wider mb-2 '>Developer Tools</h3>
